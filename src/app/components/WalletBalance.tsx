...
export default function WalletBalance() {
  ...
  if (isMobile) {
    return (
      ...
      >
        <div className="px-3 py-1.5 rounded-full flex items-center gap-1.5 backdrop-blur-sm">
          <div className="flex items-center">
            <span className="text-xs text-gray-400 drop-shadow-sm">{t('inWallet')}:</span>
            <span className="ml-1.5 text-sm font-medium bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent drop-shadow-sm">{walletBalance.toFixed(2)} GIFT</span>
          </div>
          {isPro && (
  ...
  return (
    ...
    >
      <div className="px-4 py-2 rounded-[1.5rem] flex items-center gap-2 transform transition-all duration-300 hover:translate-y-[-2px]">
        <div>
          <span className="text-sm text-gray-400 drop-shadow-sm">{t('inWallet')}:</span>
          <span className="ml-2 font-medium bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent drop-shadow-sm">{walletBalance.toFixed(2)} GIFT</span>
        </div>
        {isPro && (
